...
import { cn, PusherEvents, toPusherKey } from "@/lib/utils";
...
const Messages: FC<MessagesProps> = ({ initialMessages, sessionId, chatId, chatPartner, sessionImg }) => {
  ...
  useEffect(() => {
    ...
    pusherClient.bind(PusherEvents.MESSAGES.INCOMING, messageHandler);

    return () => {
      pusherClient.unsubscribe(toPusherKey(`chat:${chatId}`));
      pusherClient.unbind(PusherEvents.MESSAGES.INCOMING, messageHandler);
    };
  }, [chatId]);
